...
namespace FinalSis457Cllc.Controllers
{
    public class SeriesController : Controller
    {
        ...
        public SeriesController(FinalSis457CllcContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            return _context.Series != null ?
              ...
              Problem("Entity set 'FinalSis457CllcContext.Series'  is null.");
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'FinalSis457CllcContext.Series'  is null.");
            }
            var serie = await _context.Series.FindAsync(id);
            if (serie != null)
            {
